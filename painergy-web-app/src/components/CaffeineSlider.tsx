...
const CaffeineSlider: React.FC<CaffeineSliderProps> = ({ value, onChange, isInfoOpen, cascadeIndex, onInfoOpen, sliderWidth = 80, sliderHeight = 320 }) => {
        const {
            infoPos,
            setInfoPos,
            showValue,
            ...
            handleMouseMove,
            handleMouseUp,
        } = useCaffeineSlider(cascadeIndex, isInfoOpen);
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100%' }}>
            <div style={{ position: 'relative', width: sliderWidth, height: sliderHeight, background: '#f8ede3', borderRadius: '16px', boxShadow: '0 4px 24px 0 rgba(189,114,55,0.08)', display: 'flex', alignItems: 'flex-end', justifyContent: 'center' }}>
                    <div style={{
                        position: 'absolute',
                        bottom: 0,
                        left: 0,
