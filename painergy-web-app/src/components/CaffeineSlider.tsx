...
const CaffeineSlider: React.FC<CaffeineSliderProps> = ({ value, onChange, isInfoOpen, cascadeIndex, onInfoOpen }) => {
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100%' }}>
            <div style={{ position: 'relative', width: '80px', height: '320px', background: '#f8ede3', borderRadius: '16px', boxShadow: '0 4px 24px 0 rgba(189,114,55,0.08)', display: 'flex', alignItems: 'flex-end', justifyContent: 'center' }}>
                    <div style={{
                        position: 'absolute',
                        bottom: 0,
                        left: 0,
            ...
            <div style={{ marginTop: '16px', fontWeight: 'bold', fontSize: '1.2em', letterSpacing: '2px', color: '#bd7237', textTransform: 'uppercase', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                CAFFEINE
                <span style={{ marginTop: '4px', cursor: 'pointer', fontSize: '1.2em' }} title="Info about Caffeine" onClick={() => onInfoOpen(true)}>ℹ️</span>
            </div>
            {isInfoOpen && (
                <div
                    style={{
                ...
                >
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        <span style={{ fontWeight: 'bold' }}>Caffeine Slider Info</span>
                    ...
                    <div style={{ marginTop: '12px' }}>
                        This slider controls the caffeine level - for the <i>to be brewed</i> coffee. ☕<br />
